...
python -c "from semtool.app.main import main; print('[OK] Import main')"
...
python -c "from semtool.core import proxy_store; px = proxy_store.get_all_proxies(); print(f'[OK] ProxyStore: {len(px)} proxies')"
if ($LASTEXITCODE -ne 0) { 
...
python -c "from semtool.app.proxy_manager import ProxyManagerDialog; print('[OK] ProxyManager import')"
if ($LASTEXITCODE -ne 0) { 
